...
`MODE' should be set to either 'day, 'night, 'eighties, 'blue or 'bright."
  `(let* ((colors (or (cdr (assoc ,mode color-theme-sanityinc-tomorrow-colors))
          ...
          (contrast-bg2  (cdr (assoc 'selection2 colors)))
          (contrast-bg3  (cdr (assoc 'selection3 colors)))
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (company-tooltip (:background ,contrast-bg3)) ;; custom fix
      (company-tooltip-selection (:background ,contrast-bg)) ;; custom fix
